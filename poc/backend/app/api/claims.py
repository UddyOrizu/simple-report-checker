...
async def get_claim(claim_id: uuid.UUID) -> dict:
    ...
    async with async_session() as session:
        ...
        return {
            ...
            "routing_decision": claim.routing_decision,
            "suggested_search_queries": claim.suggested_search_queries or [],
            "cites_external_source": claim.cites_external_source,
            "is_opinion_or_unverifiable": claim.is_opinion_or_unverifiable,
